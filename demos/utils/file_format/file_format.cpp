...
public:
  FileFormatter(int argc, char * argv[]) : flags(argc, argv) {
  ...
  FileFormatter & SetAll(bool _in=true) {
  ...
  FileFormatter & SetFixFrontMatter(bool _in) { fix_front_matter = _in;       return *this; }
  FileFormatter & SetFixIndents(bool _in)     { fix_indentation = _in;    return *this; }
  FileFormatter & SetFixIncludes(bool _in)    { fix_include_order = _in;  return *this; }
  FileFormatter & SetFixSpaces(bool _in)      { fix_whitespace = _in;     return *this; }
  FileFormatter & SetUseGuards(bool _in)      { use_include_guards = _in; return *this; }

  FileFormatter & SetVerbose(bool _in) { verbose = _in; return *this; }
  ...
  bool Process_FixHeadings(emp::File & file) {
    std::cout << "STUB: Fixing Headings" << std::endl;
    (void) file;
    return false;
  }
  ...
  bool Process_IncludeOrder(emp::File & file) {    
    std::cout << "STUB: Fixing Includes" << std::endl;
    (void) file;
    return false;
  }
...
{
  class FileFormatter formatter(argc, argv);
}
