...
TEST_CASE("Test Point2D", "[geometry]")
{
  ...
  REQUIRE(points[0].IsNonZero() == true);
  REQUIRE(points[1].IsNonZero() == true);
  REQUIRE(points[2].IsNonZero() == true);
  REQUIRE(points[3].IsNonZero() == false);
  ...
  REQUIRE(points[4].Midpoint(points[5]) == emp::Point(4.5,4.5));
  REQUIRE(points[5].Midpoint(points[4]) == emp::Point(4.5,4.5));
  REQUIRE(points[2].Rot90().Magnitude() == 13);
  REQUIRE(points[2].Rot180().Magnitude() == 13);
  REQUIRE(points[2].Rot270().Magnitude() == 13);
}
