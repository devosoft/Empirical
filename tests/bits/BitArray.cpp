...
TEST_CASE("3: Test Simple BitArray Accessors", "[bits]"){
  emp::BitArray<1>  bs1(true);
  emp::BitArray<8>  bs8( "10001101" );
  emp::BitArray<32> bs32( "10001101100011011000110110001101" );
  emp::BitArray<64> bs64( "1000110110001101100000011000110000001101100000000000110110001101" );
  emp::BitArray<75> bs75( "010001011100010111110000011110100011111000001110100000111110010011111000011" );
...
TEST_CASE("4: Test BitArray Set*, Clear* and Toggle* Accessors", "[bits]") {
  ...
  emp::BitArray<8> bs8( "10001101" );   REQUIRE(bs8.GetValue() == 177.0);  // 10110001
  ...
  emp::BitArray<64> bs64( "11011000110110001101" );
  ...
  emp::BitArray<88> bs88( "11011000110110001101" ); REQUIRE(bs88.GetValue() == 727835.0);
  ...
  emp::Random random;
  emp::BitArray<1000> bs1k(random, 0.65);
  ...
  emp::BitArray<6> bs_empty = "000000";
  emp::BitArray<6> bs_mixed = "010101";
  emp::BitArray<6> bs_full  = "111111";
...
TEST_CASE("7: Test functions that analyze and manipulate ones", "[bits]") {
  ...
  emp::BitArray<16> bs = "0001000100001110";
...
TEST_CASE("8: Test printing and string functions.", "[bits]") {
  ...
  emp::BitArray<64> bs64("0001110000000000000100000000000001000110000001000001000100000001");
  ...
  emp::BitArray<65> bs65("00011110000000000001000000000000010001100000010000010001000000111");
...
TEST_CASE("9: Test Boolean logic and shifting functions.", "[bits]") {
  ...
  emp::BitArray<8> bs;       REQUIRE(bs == emp::BitArray<8>("00000000"));
  bs.NOT_SELF();           REQUIRE(bs == emp::BitArray<8>("11111111"));
  bs.AND_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs.AND_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs.AND_SELF(input2);     REQUIRE(bs == emp::BitArray<8>("00000011"));
  bs.AND_SELF(input3);     REQUIRE(bs == emp::BitArray<8>("00000001"));

  bs.OR_SELF(input1);      REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs.OR_SELF(input1);      REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs.OR_SELF(input3);      REQUIRE(bs == emp::BitArray<8>("01011111"));
  bs.OR_SELF(input2);      REQUIRE(bs == emp::BitArray<8>("01111111"));

  bs.NAND_SELF(input1);    REQUIRE(bs == emp::BitArray<8>("11110000"));
  bs.NAND_SELF(input1);    REQUIRE(bs == emp::BitArray<8>("11111111"));
  bs.NAND_SELF(input2);    REQUIRE(bs == emp::BitArray<8>("11001100"));
  bs.NAND_SELF(input3);    REQUIRE(bs == emp::BitArray<8>("10111011"));

  bs.NOR_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("01000000"));
  bs.NOR_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("10110000"));
  bs.NOR_SELF(input2);     REQUIRE(bs == emp::BitArray<8>("01001100"));
  bs.NOR_SELF(input3);     REQUIRE(bs == emp::BitArray<8>("10100010"));

  bs.XOR_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("10101101"));
  bs.XOR_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("10100010"));
  bs.XOR_SELF(input2);     REQUIRE(bs == emp::BitArray<8>("10010001"));
  bs.XOR_SELF(input3);     REQUIRE(bs == emp::BitArray<8>("11000100"));

  bs.EQU_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("00110100"));
  bs.EQU_SELF(input1);     REQUIRE(bs == emp::BitArray<8>("11000100"));
  bs.EQU_SELF(input2);     REQUIRE(bs == emp::BitArray<8>("00001000"));
  bs.EQU_SELF(input3);     REQUIRE(bs == emp::BitArray<8>("10100010"));

  bs.NOT_SELF();           REQUIRE(bs == emp::BitArray<8>("01011101"));

  // Test regular Boolean Logic functions.
  bs.Clear();                            REQUIRE(bs == emp::BitArray<8>("00000000"));
  emp::BitArray<8> bs1 = bs.NOT();         REQUIRE(bs1 == emp::BitArray<8>("11111111"));

  bs1 = bs1.AND(input1);                 REQUIRE(bs1 == emp::BitArray<8>("00001111"));
  emp::BitArray<8> bs2 = bs1.AND(input1);  REQUIRE(bs2 == emp::BitArray<8>("00001111"));
  emp::BitArray<8> bs3 = bs2.AND(input2);  REQUIRE(bs3 == emp::BitArray<8>("00000011"));
  emp::BitArray<8> bs4 = bs3.AND(input3);  REQUIRE(bs4 == emp::BitArray<8>("00000001"));

  bs1 = bs4.OR(input1);      REQUIRE(bs1 == emp::BitArray<8>("00001111"));
  bs2 = bs1.OR(input1);      REQUIRE(bs2 == emp::BitArray<8>("00001111"));
  bs3 = bs2.OR(input3);      REQUIRE(bs3 == emp::BitArray<8>("01011111"));
  bs4 = bs3.OR(input2);      REQUIRE(bs4 == emp::BitArray<8>("01111111"));

  bs1 = bs4.NAND(input1);    REQUIRE(bs1 == emp::BitArray<8>("11110000"));
  bs2 = bs1.NAND(input1);    REQUIRE(bs2 == emp::BitArray<8>("11111111"));
  bs3 = bs2.NAND(input2);    REQUIRE(bs3 == emp::BitArray<8>("11001100"));
  bs4 = bs3.NAND(input3);    REQUIRE(bs4 == emp::BitArray<8>("10111011"));

  bs1 = bs4.NOR(input1);     REQUIRE(bs1 == emp::BitArray<8>("01000000"));
  bs2 = bs1.NOR(input1);     REQUIRE(bs2 == emp::BitArray<8>("10110000"));
  bs3 = bs2.NOR(input2);     REQUIRE(bs3 == emp::BitArray<8>("01001100"));
  bs4 = bs3.NOR(input3);     REQUIRE(bs4 == emp::BitArray<8>("10100010"));

  bs1 = bs4.XOR(input1);     REQUIRE(bs1 == emp::BitArray<8>("10101101"));
  bs2 = bs1.XOR(input1);     REQUIRE(bs2 == emp::BitArray<8>("10100010"));
  bs3 = bs2.XOR(input2);     REQUIRE(bs3 == emp::BitArray<8>("10010001"));
  bs4 = bs3.XOR(input3);     REQUIRE(bs4 == emp::BitArray<8>("11000100"));

  bs1 = bs4.EQU(input1);     REQUIRE(bs1 == emp::BitArray<8>("00110100"));
  bs2 = bs1.EQU(input1);     REQUIRE(bs2 == emp::BitArray<8>("11000100"));
  bs3 = bs2.EQU(input2);     REQUIRE(bs3 == emp::BitArray<8>("00001000"));
  bs4 = bs3.EQU(input3);     REQUIRE(bs4 == emp::BitArray<8>("10100010"));

  bs = bs4.NOT();            REQUIRE(bs == emp::BitArray<8>("01011101"));


  // Test Boolean Logic operators.
  bs.Clear();               REQUIRE(bs == emp::BitArray<8>("00000000"));
  bs1 = ~bs;                REQUIRE(bs1 == emp::BitArray<8>("11111111"));

  bs1 = bs1 & input1;       REQUIRE(bs1 == emp::BitArray<8>("00001111"));
  bs2 = bs1 & input1;       REQUIRE(bs2 == emp::BitArray<8>("00001111"));
  bs3 = bs2 & input2;       REQUIRE(bs3 == emp::BitArray<8>("00000011"));
  bs4 = bs3 & input3;       REQUIRE(bs4 == emp::BitArray<8>("00000001"));

  bs1 = bs4 | input1;       REQUIRE(bs1 == emp::BitArray<8>("00001111"));
  bs2 = bs1 | input1;       REQUIRE(bs2 == emp::BitArray<8>("00001111"));
  bs3 = bs2 | input3;       REQUIRE(bs3 == emp::BitArray<8>("01011111"));
  bs4 = bs3 | input2;       REQUIRE(bs4 == emp::BitArray<8>("01111111"));

  bs1 = ~(bs4 & input1);    REQUIRE(bs1 == emp::BitArray<8>("11110000"));
  bs2 = ~(bs1 & input1);    REQUIRE(bs2 == emp::BitArray<8>("11111111"));
  bs3 = ~(bs2 & input2);    REQUIRE(bs3 == emp::BitArray<8>("11001100"));
  bs4 = ~(bs3 & input3);    REQUIRE(bs4 == emp::BitArray<8>("10111011"));

  bs1 = ~(bs4 | input1);    REQUIRE(bs1 == emp::BitArray<8>("01000000"));
  bs2 = ~(bs1 | input1);    REQUIRE(bs2 == emp::BitArray<8>("10110000"));
  bs3 = ~(bs2 | input2);    REQUIRE(bs3 == emp::BitArray<8>("01001100"));
  bs4 = ~(bs3 | input3);    REQUIRE(bs4 == emp::BitArray<8>("10100010"));

  bs1 = bs4 ^ input1;       REQUIRE(bs1 == emp::BitArray<8>("10101101"));
  bs2 = bs1 ^ input1;       REQUIRE(bs2 == emp::BitArray<8>("10100010"));
  bs3 = bs2 ^ input2;       REQUIRE(bs3 == emp::BitArray<8>("10010001"));
  bs4 = bs3 ^ input3;       REQUIRE(bs4 == emp::BitArray<8>("11000100"));

  bs1 = ~(bs4 ^ input1);    REQUIRE(bs1 == emp::BitArray<8>("00110100"));
  bs2 = ~(bs1 ^ input1);    REQUIRE(bs2 == emp::BitArray<8>("11000100"));
  bs3 = ~(bs2 ^ input2);    REQUIRE(bs3 == emp::BitArray<8>("00001000"));
  bs4 = ~(bs3 ^ input3);    REQUIRE(bs4 == emp::BitArray<8>("10100010"));

  bs = ~bs4;                REQUIRE(bs == emp::BitArray<8>("01011101"));


  // Test COMPOUND Boolean Logic operators.
  bs = "11111111";    REQUIRE(bs == emp::BitArray<8>("11111111"));

  bs &= input1;       REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs &= input1;       REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs &= input2;       REQUIRE(bs == emp::BitArray<8>("00000011"));
  bs &= input3;       REQUIRE(bs == emp::BitArray<8>("00000001"));

  bs |= input1;       REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs |= input1;       REQUIRE(bs == emp::BitArray<8>("00001111"));
  bs |= input3;       REQUIRE(bs == emp::BitArray<8>("01011111"));
  bs |= input2;       REQUIRE(bs == emp::BitArray<8>("01111111"));

  bs ^= input1;       REQUIRE(bs == emp::BitArray<8>("01110000"));
  bs ^= input1;       REQUIRE(bs == emp::BitArray<8>("01111111"));
  bs ^= input2;       REQUIRE(bs == emp::BitArray<8>("01001100"));
  bs ^= input3;       REQUIRE(bs == emp::BitArray<8>("00011001"));

  // Now some tests with BitArrays longer than one field.
  const emp::BitArray<80> bsl80 =
 ...
 */
void test_size(){
  emp::BitArray<42> bs42;
  REQUIRE(bs42.size() == 42);

  emp::BitArray<35> bs35;
...
void test_export(){
  ...
  bs8.SetAll();
  REQUIRE(bs8.count() == 8);
  emp::BitArray<10> bs10 = bs8.Export<10>();
...
TEST_CASE("Another Test BitArray", "[bits]")
{
  ...
  {
  emp::BitArray<3> bs_empty{0,0,0};
  emp::BitArray<3> bs_first{1,0,0};
  emp::BitArray<3> bs_last{0,0,1};
  emp::BitArray<3> bs_full{1,1,1};
  ...
  emp::BitArray<10> bs10;
  emp::BitArray<25> bs25;
  emp::BitArray<32> bs32;
  emp::BitArray<50> bs50;
  emp::BitArray<64> bs64;
  emp::BitArray<80> bs80;

  bs80[70] = 1;
  bs80 <<= 1;
  emp::BitArray<80> bs80c(bs80);

  for (size_t i = 0; i < 75; i++) {
    emp::BitArray<80> shift_set = bs80 >> i;
  ...
  {
    emp::Random random(1);
    emp::BitArray<25> bs_25;
    emp::BitArray<32> bs_32;
    emp::BitArray<50> bs_50;
    emp::BitArray<64> bs_64;
    emp::BitArray<80> bs_80;
  ...
  // serialize / deserialize
  {
    ...
    // set up
    emp::Random rand(1);
    emp::BitArray<10> bs10(rand);
    emp::BitArray<25> bs25(rand);
    emp::BitArray<32> bs32(rand);
    emp::BitArray<50> bs50(rand);
    emp::BitArray<64> bs64(rand);
    emp::BitArray<80> bs80(rand);

    emp::BitArray<10> bs10_deser;
    emp::BitArray<25> bs25_deser;
    emp::BitArray<32> bs32_deser;
    emp::BitArray<50> bs50_deser;
    emp::BitArray<64> bs64_deser;
    emp::BitArray<80> bs80_deser;
