...
struct Test_Collapse_String : emp::web::BaseTest {
  ...
  void Describe() override {
    ...
    EM_ASM({
       ...
       * target areas collapse and expand as expected
       *
       ...
       *    target_3_id should not have class "show"
       *
       * Note: Since ctrl_4_id controls multiple targets, it hard to predict its value for aria-expanded
  ...
  void Describe() override {
    ...
    EM_ASM({
      ...
      it('should have the second controller controlling emp__collapse_class_0 and emp__collapse_class_1', function(){
         ...
         *
         * first click #btn1 --->
         *    #btn1 should have class "collapsed" and aria-expanded="false"
         *    #box1 should not have class "show"
         * second click #btn1 --->
         *    #btn1 should not have class "collapsed" and should have aria-expanded="true"
         *    #box1 should have class "show"
         *
         * first click #btn2 --->
         *    #btn2 should have aria-expanded="true"
         *    #box2 should have class "show"
         * second click #btn2 --->
         *    #btn2 should have class "collapsed" and aria-expanded="false"
         *    #box2 should not have class "show"
         *
         * first click #btn3 --->
         *    #btn1 should have class "collapsed" and aria-expanded="false"
         *    #box1 should not have class "show"
         *    #btn2 should not have class "collapsed" and should have aria-expanded="true"
         *    #box2 should have class "show"
         * second click #btn3 --->
         *    #btn1 should have not class "collapsed" and should have aria-expanded="true"
         *    #box1 should have class "show"
         *    #btn2 should have class "collapsed" and aria-expanded="false"
         *    #box2 should not have class "show"
         *
         * Note: Since btn3 controls multiple targets, it hard to predict its value for aria-expanded and
...
struct Test_Collapse_Vector : emp::web::BaseTest {
  ...
  void Describe() override {
    EM_ASM({
      ...
      /* TODO: Click tests
       * first click #c1 --->
       *    #c1 should have class "collapsed" and aria-expanded="false"
       *    #c2 should have class "collapsed" and aria-expanded="false"
       *    #t1 should not have class "show"
       *    #t2 should not have class "show"
       *    #t3 should not have class "show"
       * second click #c1 --->
       *    #c1 should not have class "collapsed" and should have aria-expanded="true"
       *    #c2 should not have class "collapsed" and should have aria-expanded="true"
...
// empecable_words: btn javascript
