...
TEST_CASE("Test DataArchive", "[data]") {
    ...
    emp::vector<emp::vector<int>> arch_comp; // This is what the archive should look like
    arch_comp.push_back(emp::vector<int>({1,2,3,4,5,6,7,9,8}));

    std::cout << "Expected archive: " << emp::to_string(arch_comp) 
              << " Actual archive: " << emp::to_string(data2.GetArchive()) << std::endl;
