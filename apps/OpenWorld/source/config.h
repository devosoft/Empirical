...
EMP_BUILD_CONFIG( OpenWorldConfig,
  ...
  VALUE(PROGRAM_MAX_INST_CNT, size_t, 32, "Maximum number of instructions in a SignalGP function."),
  VALUE(PROGRAM_MIN_INST_CNT, size_t, 8, "Minimum number of instructions in a SignalGP function."),
