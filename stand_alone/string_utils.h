...
//
//  Converted to stand-alone: March 5, 2017
//
//
...
namespace emp {
  ...
  static inline void slice(const std::string & in_string, std::vector<std::string> & out_set,
                           char delim='\n') {
  ...
  static inline std::vector<std::string> slice(const std::string & in_string, char delim='\n') {
