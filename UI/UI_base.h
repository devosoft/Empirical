...
namespace UI {
  ...
  class Button_detail;
  using Button = Widget_wrap<Button_detail, const std::function<void()> &, const std::string &>;
  ...
  class Image_detail;
  using Image = Widget_wrap<Image_detail, const std::string &>;
  ...
  class Table_detail;
  using Table = Widget_wrap<Table_detail, int, int>;
