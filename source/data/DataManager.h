...
namespace emp {
  ...
  /** DataManagers handle sets of DataNode objects that all have the same
   * tracking settings */
  ...
  public:
    ...
    /** Creates a new DataNode and adds it to this DataManager, with the name 
     *  specified in @param name. */
