...
struct VertexAttributeTypeOf<GLubyte> {
  static constexpr bool supported = true;
  static constexpr VertexAttributeType type = VertexAttributeType::UnsignedByte;
};
...
struct VertexAttributeTypeOf<GLuint> {
  static constexpr bool supported = true;
  static constexpr VertexAttributeType type = VertexAttributeType::UnsignedInt;
};
...
class VertexArrayObjectConfigurator {
  ...
  VertexArrayObjectConfigurator(const VertexArrayObjectConfigurator&) = delete;
  ...
  VertexArrayObjectConfigurator& operator=(VertexArrayObjectConfigurator&&) =
    delete;
