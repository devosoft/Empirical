...
#define DEFINE_ATTR(NAME, _name)                                               \
  struct NAME {                                                                \
    template <class T>                                                         \
    struct Value : emp::plot::attrs::value_tag {                               \
    ...
    return out << "{ " << value._name << " }" << std::endl;                    \
      ...
      namespace __impl {
        ...
        class AttrsParent : public T... {
          ...
          template <class U>
          struct __impl_constructor_detector : args_tag {};

          template <class... U>
          struct __impl_constructor_detector<Attrs<U...>> : copy_tag {};

          template <class U>
          using constructor_detector =
            __impl_constructor_detector<std::decay_t<U>>;
      ...
      class Attrs : public Joinable<Attrs<T...>>,
                    ...
                    public __impl::AttrsParent<T...> {
        public:
        template <class U0, class... U>
        constexpr Attrs(U0&& arg, U&&... args)
          : __impl::AttrsParent<T...>(
              typename __impl::AttrsParent<T...>::template constructor_detector<
                U0>{},
      ...
      std::ostream& operator<<(std::ostream& out, const Attrs<H, T...>& attrs) {
        out << "{ ";
        __impl::printAttrs(out, attrs, __impl::print_attrs_tag<H, T...>{});
        return out << " }";
      }
