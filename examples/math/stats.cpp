...
int main()
{
  ...
  std::cout << "v1 = " << emp::to_string(v1) << '\n';
  std::cout << "v2 = " << emp::to_string(v2) << '\n';
  std::cout << "v3 = " << emp::to_string(v3) << '\n';
  std::cout << "v4 = " << emp::to_string(v4) << '\n';
  ...
  std::cout << "v5 = " << emp::to_string(v5) << '\n';
  std::cout << "ShannonEntropy(v5) = " << emp::ShannonEntropy(v5) << '\n';
  std::cout << "ShannonEntropy(vp5) = " << emp::ShannonEntropy(vp5) << '\n';
