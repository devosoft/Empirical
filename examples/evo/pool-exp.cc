...
using MixedWorld = emp::evo::World<ORG, emp::evo::PopulationManager_Pools<ORG>, emp::evo::LineagePruned >;
...
int main(int argc, char* argv[])
{
  ...
  emp::vector<int> ps = {20};
  std::map<int, emp::vector<int> >connections;

  mixed_pop.ConfigPop(5, ps, &connections, 150, 10, 0.05, POP_SIZE);
