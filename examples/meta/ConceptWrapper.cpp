 ...
 *  @date 2018
 *
 *  @file ConceptWrapper.cpp
 *  @brief Some examples code for using emp::ConceptWrapper template
 */

#include <iostream>

#include "emp/base/Ptr.hpp"
#include "emp/meta/ConceptWrapper.hpp"
...
int main() {
  ...
  [[maybe_unused]] TestConcept<MinimalClass>::test1_t a = 10;
  [[maybe_unused]] TestConcept<MinimalClass>::test2_t b = 20;
