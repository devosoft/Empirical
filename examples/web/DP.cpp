...
int main()
{
  ...
  << "<p>Yes!</p>"
  << "<p>For word <i>n</i>, we can either exclude the word from the answer (and just use the answer same score as <i>n</i>-1) -or- we can include it.  If we include it, we must exclude <i>n</i>-1, so we take the length of word <i>n</i> and add it to the best score for the first <i>n</i>-2 words.</p>";
