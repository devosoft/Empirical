 ...
 *
 * @file include/emp/games/PayoffMatrix.hpp
...
#ifndef INCLUDE_EMP_GAMES_PAYOFF_MATRIX_HPP_GUARD
#define INCLUDE_EMP_GAMES_PAYOFF_MATRIX_HPP_GUARD
...
namespace emp {
  ...
  public:
    ...
    std::unordered_map<int, double> AsInput(size_t /*player_id*/) const {
      ...
      out_map[-1] = num_moves;
      for (size_t i = 0; i < payoff.size(); i++) { out_map[i] = payoff[i]; }
      return out_map;
    }
  };
...
#endif  // #ifndef INCLUDE_EMP_GAMES_PAYOFF_MATRIX_HPP_GUARD
