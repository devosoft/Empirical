 ...
 *
 * @file include/emp/datastructs/tuple_utils.hpp
...
#ifndef INCLUDE_EMP_DATASTRUCTS_TUPLE_UTILS_HPP_GUARD
#define INCLUDE_EMP_DATASTRUCTS_TUPLE_UTILS_HPP_GUARD
...
namespace emp {
  ...
  constexpr inline int tuple_size() {
  ...
  struct TupleHash {
    ...
    std::size_t operator()(const tuple_t & tup) const {
      return std::apply([](TYPES... args) { return emp::CombineHash<TYPES...>(args...); }, tup);
    }
  };
  ...
  void TupleIterate(TUP1_T & tup1, TUP2_T & tup2, const FUN_T & fun) {
    ...
    internal::TupleIterate2_impl<TUP1_T, TUP2_T, FUN_T, tuple_size<TUP1_T>(), 0>::Run(tup1,
                                                                                      tup2,
                                                                                      fun);
  }
}  // namespace emp

#endif  // #ifndef INCLUDE_EMP_DATASTRUCTS_TUPLE_UTILS_HPP_GUARD
