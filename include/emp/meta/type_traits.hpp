...
namespace emp {
  ...
  auto & remove_ptr_value(T & value) {
    if constexpr (is_ptr_type<T>::value) {
      return *value;
    } else {
      return value;
    }
  ...
  static constexpr auto StateBitCount() {
    if constexpr (NUM_STATES <= 256) {
      return uint8_t{8};
    } else if constexpr (NUM_STATES <= 65536) {
      return uint16_t{16};
    } else if constexpr (NUM_STATES <= 4'294'967'296) {
      return uint32_t{32};
    } else {
      return uint64_t{64};
    }
  ...
  namespace __impl_variadics_type_traits {
    ...
    template <bool, typename Needle, typename Haystack, template <typename, typename> class Cmp>
    ...
    template <typename Needle, typename U0, typename... U, template <typename, typename> class Cmp>
    struct variadic_contains<Needle, __impl_variadics_type_traits::pack<U0, U...>, Cmp>
      : __impl_variadics_type_traits::
          variadic_contains_switch<Cmp<Needle, U0>::value,
                                   Needle,
                                   __impl_variadics_type_traits::pack<U...>,
                                   Cmp> {};

    template <typename Needle, typename Haystack, template <typename, typename> class Cmp>
    struct variadic_contains_switch<true, Needle, Haystack, Cmp> : std::true_type {};
  ...
  template <typename Needle, typename Haystack, template <typename, typename> class Cmp = std::is_same>
  struct variadic_contains;
  ...
  struct variadic_contains<Needle, Variadic<U...>, Cmp>
    : __impl_variadics_type_traits::
        variadic_contains<Needle, __impl_variadics_type_traits::pack<U...>, Cmp> {};
  ...
  namespace __impl_variadics_type_traits {
    ...
    template <template <typename...> class Variadic, class... A, class... B, class... Rest>
    struct variadic_concat<Variadic, pack<pack<A...>, Variadic<B...>, Rest...>> {
      using type = typename variadic_concat<Variadic, pack<pack<A..., B...>, Rest...>>::type;
    };
  }  // namespace __impl_variadics_type_traits
  ...
  struct variadic_concat<Variadic<A...>, Rest...> {
    using type = __impl_variadics_type_traits::FromPackType<
      ...
      typename __impl_variadics_type_traits::variadic_concat<
        Variadic,
        __impl_variadics_type_traits::pack<__impl_variadics_type_traits::pack<A...>, Rest...>>::type>;
  };
  ...
  namespace __impl_variadics_type_traits {
    ...
    template <typename Filtered, typename Unfiltered, template <typename> class Filter>
    struct variadic_filter;

    template <bool, typename Filtered, typename Unfiltered, template <typename> class Filter>
    ...
    template <typename... Filtered, typename R0, typename... Rest, template <typename> class Filter>
    struct variadic_filter<pack<Filtered...>, pack<R0, Rest...>, Filter>
      : variadic_filter_switch<Filter<R0>::value, pack<Filtered...>, pack<R0, Rest...>, Filter> {};

    template <typename... Filtered, typename R0, typename... Rest, template <typename> class Filter>
    struct variadic_filter_switch<false, pack<Filtered...>, pack<R0, Rest...>, Filter> {
      using type = typename variadic_filter<pack<Filtered...>, pack<Rest...>, Filter>::type;
    };

    template <typename... Filtered, typename R0, typename... Rest, template <typename> class Filter>
    struct variadic_filter_switch<true, pack<Filtered...>, pack<R0, Rest...>, Filter> {
      using type = typename variadic_filter<pack<Filtered..., R0>, pack<Rest...>, Filter>::type;
    };
  }  // namespace __impl_variadics_type_traits
  ...
  struct variadic_filter<Variadic<U...>, Filter> {
    using type = __impl_variadics_type_traits::FromPackType<
      Variadic,
      typename __impl_variadics_type_traits::variadic_filter<__impl_variadics_type_traits::pack<>,
                                                             __impl_variadics_type_traits::pack<U...>,
                                                             Filter>::type>;
  };

  // -- variadic_remove_duplicates --
  template <typename Variadic, template <typename, typename> class Cmp = std::is_same>
  ...
  namespace __impl_variadics_type_traits {
    ...
    template <typename Unique, typename Remaining, template <typename, typename> class Cmp>
    struct variadic_remove_duplicates;

    template <bool, typename Unique, typename Remaining, template <typename, typename> class Cmp>
    struct variadic_remove_duplicates_switch;

    template <typename Unique, typename... Rest, template <typename, typename> class Cmp>
    ...
    struct variadic_remove_duplicates<pack<Unique...>, pack<R0, Rest...>, Cmp>
      : variadic_remove_duplicates_switch<variadic_contains_v<R0, pack<Unique...>, Cmp>,
                                          pack<Unique...>,
                                          pack<R0, Rest...>,
                                          Cmp> {};
    ...
    struct variadic_remove_duplicates_switch<false, pack<Unique...>, pack<R0, Rest...>, Cmp> {
      using type =
        typename variadic_remove_duplicates<pack<Unique..., R0>, pack<Rest...>, Cmp>::type;
    };
    ...
    struct variadic_remove_duplicates_switch<true, pack<Unique...>, pack<R0, Rest...>, Cmp> {
      using type = typename variadic_remove_duplicates<pack<Unique...>, pack<Rest...>, Cmp>::type;
    };
  }  // namespace __impl_variadics_type_traits
  ...
  struct variadic_remove_duplicates<Variadic<U...>, Cmp> {
    using type = __impl_variadics_type_traits::
      FromPackType<Variadic,
                   typename __impl_variadics_type_traits::
                     variadic_remove_duplicates<__impl_variadics_type_traits::pack<>,
                                                __impl_variadics_type_traits::pack<U...>,
                                                Cmp>::type>;
  };
  ...
  namespace __impl_variadics_type_traits {
    ...
    private:
      ...
      template <typename T>
      struct not_in_first : std::integral_constant<bool, !variadic_contains_v<T, first_t, Cmp>> {};
  ...
  struct variadic_union<Cmp, Variadic<U...>> {
    using type = __impl_variadics_type_traits::
      FromPackType<Variadic,
                   variadic_remove_duplicates_t<__impl_variadics_type_traits::pack<U...>, Cmp>>;
  };
  ...
  struct variadic_union<Cmp, Variadic<U0...>, U1, U...> {
    using type = __impl_variadics_type_traits::
      FromPackType<Variadic,
                   typename __impl_variadics_type_traits::
                     variadic_union<Cmp,
                                    __impl_variadics_type_traits::pack<U0...>,
  ...
  namespace __impl_variadics_type_traits {
    ...
    private:
      ...
      template <typename T>
      struct in_second : std::integral_constant<bool, variadic_contains_v<T, second_t, Cmp>> {};
    ...
    public:
      ...
      using type = typename variadic_intersection<Cmp, intersection_t, U...>::type;
    };
  }  // namespace __impl_variadics_type_traits
  ...
  namespace __impl_variadics_type_traits {
    ...
    template <size_t I, typename Needle, typename Haystack, template <typename, typename> class Cmp>
    struct variadic_index_of;

    template <bool, size_t, typename Needle, typename Haystack, template <typename, typename> class Cmp>
    struct variadic_index_ofSwitch;

    template <size_t I, typename Needle, typename... U, template <typename, typename> class Cmp>
    ...
    struct variadic_index_of<I, Needle, pack<U0, U...>, Cmp>
      : variadic_index_ofSwitch<Cmp<Needle, U0>::value, I, Needle, pack<U...>, Cmp> {};

  }  // namespace __impl_variadics_type_traits

  template <typename Needle,
            template <typename...> class Haystack,
            typename... U,
            template <typename, typename> class Cmp>
  struct variadic_index_of<Needle, Haystack<U...>, Cmp>
    : __impl_variadics_type_traits::
        variadic_index_of<0, Needle, __impl_variadics_type_traits::pack<U...>, Cmp> {};

}  // namespace emp

#endif  // #ifndef INCLUDE_EMP_META_TYPE_TRAITS_HPP_GUARD
