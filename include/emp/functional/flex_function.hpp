...
namespace emp {
  ...
  template <class T>
  class flex_function;  // Not defined.
  ...
  public:
    ...
    void SetDefaults(ARGS... args) { default_args = std::make_tuple(args...); }
    ...
    return_t operator()(IN_ARGS &&... k) const {
      ...
      static_assert(in_args < num_args,
...
#endif  // #ifndef INCLUDE_EMP_FUNCTIONAL_FLEX_FUNCTION_HPP_GUARD
