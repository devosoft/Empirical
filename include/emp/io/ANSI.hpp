...
namespace emp { namespace ANSI {
  ...
  [[nodiscard]] inline std::string Apply(const char * start,
                                         std::string_view sv,
                                         const char * end) {
  ...
  [[nodiscard]] inline std::string MakeFaint(std::string_view sv) {
    return Apply(Faint, sv, NoBold);
  }

  [[nodiscard]] inline std::string MakeItalic(std::string_view sv) {
    return Apply(Italic, sv, NoItalic);
  }

  [[nodiscard]] inline std::string MakeUnderline(std::string_view sv) {
    return Apply(Underline, sv, NoUnderline);
  }

  [[nodiscard]] inline std::string MakeSlowBlink(std::string_view sv) {
    return Apply(SlowBlink, sv, NoBlink);
  }

  [[nodiscard]] inline std::string MakeBlink(std::string_view sv) {
    return Apply(Blink, sv, NoBlink);
  }

  [[nodiscard]] inline std::string MakeReverse(std::string_view sv) {
    return Apply(Reverse, sv, NoReverse);
  }

  [[nodiscard]] inline std::string MakeStrike(std::string_view sv) {
    return Apply(Strike, sv, NoStrike);
  }
  ...
  [[nodiscard]] inline std::string MakeMagenta(std::string_view sv) {
    return MakeColor(sv, Magenta);
  }
  ...
  [[nodiscard]] inline std::string MakeBrightBlack(std::string_view sv) {
    return MakeColor(sv, BrightBlack);
  }

  [[nodiscard]] inline std::string MakeBrightRed(std::string_view sv) {
    return MakeColor(sv, BrightRed);
  }

  [[nodiscard]] inline std::string MakeBrightGreen(std::string_view sv) {
    return MakeColor(sv, BrightGreen);
  }

  [[nodiscard]] inline std::string MakeBrightYellow(std::string_view sv) {
    return MakeColor(sv, BrightYellow);
  }

  [[nodiscard]] inline std::string MakeBrightBlue(std::string_view sv) {
    return MakeColor(sv, BrightBlue);
  }

  [[nodiscard]] inline std::string MakeBrightMagenta(std::string_view sv) {
    return MakeColor(sv, BrightMagenta);
  }

  [[nodiscard]] inline std::string MakeBrightCyan(std::string_view sv) {
    return MakeColor(sv, BrightCyan);
  }

  [[nodiscard]] inline std::string MakeBrightWhite(std::string_view sv) {
    return MakeColor(sv, BrightWhite);
  }
  ...
  [[nodiscard]] inline std::string MakeBlackBG(std::string_view sv) {
    return MakeBGColor(sv, BlackBG);
  }

  [[nodiscard]] inline std::string MakeRedBG(std::string_view sv) { return MakeBGColor(sv, RedBG); }

  [[nodiscard]] inline std::string MakeGreenBG(std::string_view sv) {
    return MakeBGColor(sv, GreenBG);
  }

  [[nodiscard]] inline std::string MakeYellowBG(std::string_view sv) {
    return MakeBGColor(sv, YellowBG);
  }

  [[nodiscard]] inline std::string MakeBlueBG(std::string_view sv) {
    return MakeBGColor(sv, BlueBG);
  }

  [[nodiscard]] inline std::string MakeMagentaBG(std::string_view sv) {
    return MakeBGColor(sv, MagentaBG);
  }

  [[nodiscard]] inline std::string MakeCyanBG(std::string_view sv) {
    return MakeBGColor(sv, CyanBG);
  }

  [[nodiscard]] inline std::string MakeWhiteBG(std::string_view sv) {
    return MakeBGColor(sv, WhiteBG);
  }

  [[nodiscard]] inline std::string MakeBrightBlackBG(std::string_view sv) {
    return MakeBGColor(sv, BrightBlackBG);
  }

  [[nodiscard]] inline std::string MakeBrightRedBG(std::string_view sv) {
    return MakeBGColor(sv, BrightRedBG);
  }

  [[nodiscard]] inline std::string MakeBrightGreenBG(std::string_view sv) {
    return MakeBGColor(sv, BrightGreenBG);
  }

  [[nodiscard]] inline std::string MakeBrightYellowBG(std::string_view sv) {
    return MakeBGColor(sv, BrightYellowBG);
  }

  [[nodiscard]] inline std::string MakeBrightBlueBG(std::string_view sv) {
    return MakeBGColor(sv, BrightBlueBG);
  }

  [[nodiscard]] inline std::string MakeBrightMagentaBG(std::string_view sv) {
    return MakeBGColor(sv, BrightMagentaBG);
  }

  [[nodiscard]] inline std::string MakeBrightCyanBG(std::string_view sv) {
    return MakeBGColor(sv, BrightCyanBG);
  }

  [[nodiscard]] inline std::string MakeBrightWhiteBG(std::string_view sv) {
    return MakeBGColor(sv, BrightWhiteBG);
  }
}}  // namespace emp::ANSI

#endif  // #ifndef INCLUDE_EMP_IO_ANSI_HPP_GUARD
