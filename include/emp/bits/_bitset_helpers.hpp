...
#ifndef INCLUDE_EMP_BITS_BITSET_HELPERS_HPP_impl_GUARD
#define INCLUDE_EMP_BITS_BITSET_HELPERS_HPP_impl_GUARD
...
namespace emp {
  ...
  public:
    ...
    inline BitProxy & Set(bool b = true) {
      bit_container.Set(index, b);
      return *this;
    }

    inline BitProxy & Clear() {
      bit_container.Clear(index);
      return *this;
    }

    inline BitProxy & Toggle() {
      bit_container.Toggle(index);
      return *this;
    }

    inline BitProxy & SetIf(bool test, bool b) {
      if (test) { Set(b); }
      return *this;
    }

    inline BitProxy & ToggleIf(bool test) {
      if (test) { Toggle(); }
      return *this;
    }
...
#endif  // #ifndef INCLUDE_EMP_BITS_BITSET_HELPERS_HPP_impl_GUARD
