 ...
 *
 * @file include/emp/matching/matchbin_regulators.hpp
...
#ifndef INCLUDE_EMP_MATCHING_MATCHBIN_REGULATORS_HPP_GUARD
#define INCLUDE_EMP_MATCHING_MATCHBIN_REGULATORS_HPP_GUARD
