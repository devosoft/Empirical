...
#define EMP_CONFIG_BASE_NAME EMP_NAMESPACE_OBJLIKE::Config
#define EMP_BUILD_CONFIG(CLASS_NAME, ...) EMP_EXTEND_CONFIG(CLASS_NAME, EMP_CONFIG_BASE_NAME, __VA_ARGS__)
