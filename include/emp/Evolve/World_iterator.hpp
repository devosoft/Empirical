 ...
 *
 * @file include/emp/Evolve/World_iterator.hpp
...
#ifndef INCLUDE_EMP_EVOLVE_WORLD_ITERATOR_HPP_GUARD
#define INCLUDE_EMP_EVOLVE_WORLD_ITERATOR_HPP_GUARD
...
namespace emp {
  ...
  public:
    ...
    World_iterator(const World_iterator & _in) : world_ptr(_in.world_ptr), pos(_in.pos) {
      MakeValid();
    }
...
#endif  // #ifndef INCLUDE_EMP_EVOLVE_WORLD_ITERATOR_HPP_GUARD
