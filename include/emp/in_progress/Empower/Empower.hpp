 ...
 *
 * @file include/emp/in_progress/Empower/Empower.hpp
...
#ifndef INCLUDE_EMP_IN_PROGRESS_EMPOWER_EMPOWER_HPP_GUARD
#define INCLUDE_EMP_IN_PROGRESS_EMPOWER_EMPOWER_HPP_GUARD
...
namespace emp {
  ...
  public:
    ...
    public:
      ...
      Empower & GetEmpower() {
        emp_assert(empower_ptr != nullptr);
        return *empower_ptr;
      }

      const Empower & GetEmpower() const {
        emp_assert(empower_ptr != nullptr);
        return *empower_ptr;
      }
  ...
  protected:
    ...
    using cconstruct_fun_t =
      std::function<void(const VarInfo &, const MemoryImage &, MemoryImage &)>;
    ...
    struct Type {
      ...
      Type(size_t _id,
           ...
           size_t _size,
           const dconstruct_fun_t & dc_fun,
           const cconstruct_fun_t & cc_fun,
           const copy_fun_t & c_fun,
           const destruct_fun_t & d_fun)
        : type_id(_id)
        , type_name(_name)
        , mem_size(_size)
        , dconstruct_fun(dc_fun)
  ...
  public:
    ...
    size_t GetTypeID() {
      ...
      dconstruct_fun_t dconstruct_fun = [](const VarInfo & var_info, MemoryImage & new_image) {
...
#endif  // #ifndef INCLUDE_EMP_IN_PROGRESS_EMPOWER_EMPOWER_HPP_GUARD

// Local settings for Empecable file checker.
// empecable_words: dconstruct cconstruct
