 ...
 *
 * @file include/emp/in_progress/constexpr/ce_array.hpp
...
#ifndef INCLUDE_EMP_IN_PROGRESS_CONSTEXPR_CE_ARRAY_HPP_GUARD
#define INCLUDE_EMP_IN_PROGRESS_CONSTEXPR_CE_ARRAY_HPP_GUARD
...
namespace emp {
  ...
  public:
    ...
    constexpr const T & operator[](size_t id) const {
      return (id < p1_size) ? p1[id] : p2[id - p1_size];
    }
...
#endif  // #ifndef INCLUDE_EMP_IN_PROGRESS_CONSTEXPR_CE_ARRAY_HPP_GUARD
