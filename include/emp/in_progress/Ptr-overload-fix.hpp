...
//////////////////////////////////
  ...
  public:
    ...
    template <typename T2> Ptr<TYPE> & operator=(std::enable_if_t<std::is_convertible_v<T2*,TYPE*>,T2*> _in) & { ptr = _in; return *this; }
    template <typename T2> Ptr<TYPE> & operator=(std::enable_if_t<std::is_convertible_v<T2*,TYPE*>, Ptr<T2> > _in) & { ptr = _in.Raw(); return *this; }
