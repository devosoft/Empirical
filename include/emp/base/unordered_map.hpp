...
namespace emp {
  ...
  public:
    ...
    template <class InputIterator>
    unordered_map(InputIterator first, InputIterator last, size_type n, const allocator_type & alloc)
    ...
    unordered_map(std::initializer_list<value_type> il, size_type n, const allocator_type & alloc)
      : base_t(il, n, alloc) {}
