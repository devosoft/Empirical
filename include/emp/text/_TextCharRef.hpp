 ...
 *
 * @file include/emp/text/_TextCharRef.hpp
...
#ifndef INCLUDE_EMP_TEXT_TEXT_CHAR_REF_HPP_impl_GUARD
#define INCLUDE_EMP_TEXT_TEXT_CHAR_REF_HPP_impl_GUARD
...
namespace emp {
  ...
  public:
    ...
    auto operator<=>(char in) const { return text_ref.GetChar(pos) <=> in; }
...
#endif  // #ifndef INCLUDE_EMP_TEXT_TEXT_CHAR_REF_HPP_impl_GUARD
