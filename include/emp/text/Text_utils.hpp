...
namespace emp {
  ...
  [[maybe_unused]] static const auto & GetTextSymbolNames() {
    ...
    if (symbol_map.size() == 0) {
      ...
      symbol_map.emplace("napos",
                         329,
                         "ŉ",
                         'n',
                         "Latin small letter n preceded by apostrophe");  // DEPRECATED!
...
#endif  // #ifndef INCLUDE_EMP_TEXT_TEXT_UTILS_HPP_GUARD

// Local settings for Empecable file checker.
// empecable_words: oplus nabla forall lrm equiv ang isin rarr lcaron zdot lowast congurent nsub rceil zwnj circ crarr harr darr otimes ubreve sbquo zwj infin rsquo ncaron rfloor scedil eng thetasym emsp hellip zcaron radic ccirc ebreve fnof uarr jcirc mdash longfs notin zacute tstrok wcirc ndash diaeres ycirc larr upsih uogon uring permil scirc eth abreve ncedil rcaron oelig rcedil udblac racute obreve napos lcedil tcaron lacute diams rlm kcedil ijlig imath sigmaf imacr itilde ucirc hstrok dcaron gdot ecaron rdquo omacr sacute eogon lceil ldquo caron loz ccaron ogonek oline amacr yuml eacute lsaquo cacute lfloor aelig brvbar uml sdot gcedil cdot lmidot nacute asymp yacute uacute bdquo ouml ecirc aogon ugrave otilde jlig thinsp tcedil kgreen ocirc oacute odblac emacr icirc elig cong igrave laquo scaron ibreve ntilde umacr aring perp plusmn oslash idot sube acirc auml curren edot iacute atilde egrave iquest gcirc ensp iogon agrave deg lsquo ordf aacute raquo hcirc kra utilde ccedil euml iuml piv dstrok cedil rsaquo uuml mille macr lstrok supe ordm ograve gbreve szlig iexcl
