 ...
 *
 * @file include/emp/web/_TableCol.hpp
...
#ifndef INCLUDE_EMP_WEB_TABLE_COL_HPP_impl_GUARD
#define INCLUDE_EMP_WEB_TABLE_COL_HPP_impl_GUARD
...
namespace emp { namespace web {
  ...
  public:
    ...
    TableCol & Clear() {
      Info()->ClearCol(cur_col);
      return *this;
    }

    TableCol & ClearStyle() {
      Info()->cols[cur_col].extras.style.Clear();
      return *this;
    }

    TableCol & ClearAttr() {
      Info()->cols[cur_col].extras.attr.Clear();
      return *this;
    }

    TableCol & ClearListen() {
      Info()->cols[cur_col].extras.listen.Clear();
      return *this;
    }

    TableCol & ClearExtras() {
      Info()->cols[cur_col].extras.Clear();
      return *this;
    }

    TableCol & ClearChildren() {
      Info()->ClearColChildren(cur_col);
      return *this;
    }
...
#endif  // #ifndef INCLUDE_EMP_WEB_TABLE_COL_HPP_impl_GUARD
