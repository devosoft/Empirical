...
namespace D3 {
  ...
  public:
      ...
      void Remove(){
        MAIN_THREAD_EMP_ASM({js.objects[$0].remove()},
          this->id);
      }
      ...
      */
      ...
      SetAttr(std::string name, T value) {
        ...
        MAIN_THREAD_EMP_ASM({js.objects[$0].attr(UTF8ToString($1), $2)},
      ...
      */
      ...
      SetStyle(std::string name, T value, bool priority=false){
        if (priority){
    	    ...
    	    MAIN_THREAD_EMP_ASM({js.objects[$0].style(UTF8ToString($1), $2)},
              this->id, name.c_str(), value);
        }
        return *(static_cast<DERIVED *>(this));
      }
  ...
  public:
    ...
    Selection(){
        MAIN_THREAD_EMP_ASM({js.objects[$0] = d3.selection();}, this->id);
    };
    ...
    ***********************************************/
    ...
    SetProperty(std::string name, T value){
      MAIN_THREAD_EMP_ASM({js.objects[$0].property(UTF8ToString($1),
    ...
    ***********************************************/
    ...
    Selection& Order(){
      MAIN_THREAD_EMP_ASM({js.objects[$0].order()},
			this->id);
      return *this;
    }

    Selection& Raise() {
      MAIN_THREAD_EMP_ASM({js.objects[$0].raise();}, this->id);
      return *this;
    }

    Selection& Lower() {
      MAIN_THREAD_EMP_ASM({js.objects[$0].lower();}, this->id);
      return *this;
    }
