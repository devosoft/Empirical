 ...
 *
 * @file include/emp/web/d3/visual_elements.hpp
 * @brief TODO.
 *
 */
...
#ifndef INCLUDE_EMP_WEB_D3_VISUAL_ELEMENTS_HPP_GUARD
#define INCLUDE_EMP_WEB_D3_VISUAL_ELEMENTS_HPP_GUARD
...
namespace D3 {
  ...
  public:
    ...
    std::function<int(NODE)> GetX = [this](NODE n) { return cell_size * (n.loc() % grid_width); };

    std::function<int(NODE)> GetY = [this](NODE n) { return cell_size * (n.loc() / grid_width); };
    ...
    TileGrid(int width, int height, int cell_size, D3::Selection & svg)
      ...
      svg.SetAttr("width", cell_size * grid_width).SetAttr("height", cell_size * grid_height);
      for (int i = 0; i < grid_width * grid_height; ++i) { data[i].loc(i); }
...
#endif  // #ifndef INCLUDE_EMP_WEB_D3_VISUAL_ELEMENTS_HPP_GUARD

// Local settings for Empecable file checker.
// empecable_words: loc svg
