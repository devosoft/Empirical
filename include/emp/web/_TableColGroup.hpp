 ...
 *
 * @file include/emp/web/_TableColGroup.hpp
...
#ifndef INCLUDE_EMP_WEB_TABLE_COL_GROUP_HPP_impl_GUARD
#define INCLUDE_EMP_WEB_TABLE_COL_GROUP_HPP_impl_GUARD
...
namespace emp { namespace web {
  ...
  public:
    ...
    TableColGroup & Clear() {
      Info()->ClearColGroup(cur_col);
      return *this;
    }

    TableColGroup & ClearStyle() {
      Info()->col_groups[cur_col].extras.style.Clear();
      return *this;
    }

    TableColGroup & ClearAttr() {
      Info()->col_groups[cur_col].extras.attr.Clear();
      return *this;
    }

    TableColGroup & ClearListen() {
      Info()->col_groups[cur_col].extras.listen.Clear();
      return *this;
    }

    TableColGroup & ClearExtras() {
      Info()->col_groups[cur_col].extras.Clear();
      return *this;
    }

    TableColGroup & ClearChildren() {
      Info()->ClearColGroupChildren(cur_col);
      return *this;
    }
...
#endif  // #ifndef INCLUDE_EMP_WEB_TABLE_COL_GROUP_HPP_impl_GUARD
