 ...
 *
 * @file include/emp/web/_TableCell.hpp
...
#ifndef INCLUDE_EMP_WEB_TABLE_CELL_HPP_impl_GUARD
#define INCLUDE_EMP_WEB_TABLE_CELL_HPP_impl_GUARD
...
namespace emp { namespace web {
  ...
  public:
    ...
    TableCell & Clear() {
      Info()->ClearCell(cur_row, cur_col);
      return *this;
    }

    TableCell & ClearStyle() {
      Info()->rows[cur_row].data[cur_col].extras.style.Clear();
      return *this;
    }

    TableCell & ClearAttr() {
      Info()->rows[cur_row].data[cur_col].extras.attr.Clear();
      return *this;
    }

    TableCell & ClearListen() {
      Info()->rows[cur_row].data[cur_col].extras.listen.Clear();
      return *this;
    }

    TableCell & ClearExtras() {
      Info()->rows[cur_row].data[cur_col].extras.Clear();
      return *this;
    }

    TableCell & ClearChildren() {
      Info()->ClearCellChildren(cur_row, cur_col);
      return *this;
    }
...
#endif  // #ifndef INCLUDE_EMP_WEB_TABLE_CELL_HPP_impl_GUARD
