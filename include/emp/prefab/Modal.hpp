 ...
 *
 * @file include/emp/prefab/Modal.hpp
 * @brief Wraps a Bootstrap modal.
 */

#pragma once

#ifndef INCLUDE_EMP_PREFAB_MODAL_HPP_GUARD
#define INCLUDE_EMP_PREFAB_MODAL_HPP_GUARD
...
namespace emp { namespace prefab {
  ...
  public:
    ...
    void AddButton(web::Button & btn) {
      btn.SetAttr("data-toggle", "modal", "data-target", "#" + this->GetID());
    }
     ...
     */
    void SetBackground(const std::string color) { modal_content.SetBackground(color); }
  };
}}  // namespace emp::prefab

#endif  // #ifndef INCLUDE_EMP_PREFAB_MODAL_HPP_GUARD
