...
namespace emp {
  ...
  public:
    ...
    private:
      ...
      size_t index;
    public:
      iterator_t(emp::Ptr<const this_t> _ptr, size_t _index) : ptr(_ptr), index(_index) {
        MakeValid();
      }
      ...
      bool operator==(const iterator_t & in) const noexcept {
        return ptr == in.ptr && index == in.index;
      }
...
#endif  // #ifndef INCLUDE_EMP_TOOLS_CHAR_UTILS_HPP_GUARD
